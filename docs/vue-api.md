...
完整 Vue 2 Options API 單檔元件範例請參考 [`demo/vue2-grid.vue`](../demo/vue2-grid.vue)。
...
開啟 `http://127.0.0.1:4174/demo/vue2-sfc-dev.html`。修改 `demo/vue2-grid.vue` 後瀏覽器會自動更新。
...
輸出位於 `dist-vue-demo/`，部署整個目錄即可；產品入口為 `dist-vue-demo/vue2-grid-app.html`。
