...
test('Diagram demos reproduce the manufacturing process reference layout', function() {
  ...
  assert.match(buildHtml, /dist\/fabLoader\.js/);
  assert.doesNotMatch(buildHtml, /\.queue\(\)/);
  assert.match(buildHtml, /fabLoader[\s\S]*?\.style\(\[/);
  assert.match(buildHtml, /\.style\(\[/);
  assert.doesNotMatch(buildHtml, /\.styles\(/);
  assert.match(buildHtml, /\.script\(/);
  assert.match(buildHtml, /\.module\(/);
  assert.match(buildHtml, /data-cdn-dayjs/);
  assert.match(buildHtml, /cdn\.jsdelivr\.net\/npm\/dayjs@1\.11\.13/);
  assert.match(devHtml, /id="test"/);
  assert.match(buildHtml, /id="test"/);
  assert.match(devHtml, /mountHtml\('#test', '\.\/test\.html'\)/);
  assert.match(buildHtml, /mountHtml\('#test', '\.\/test\.html'\)/);
