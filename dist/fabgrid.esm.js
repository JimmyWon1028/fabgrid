/*! FabGrid ESM | performance-first data grid */
export function createFabGridFactory() {
  'use strict';
  ...
  FabGrid.prototype.renderTopLeftSearchCount = function(element, title, showCount) {
