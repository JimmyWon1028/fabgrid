...
import { createGanttFactory } from './gantt/gantt.js?v=20260728-locale-packs-v1';

if (!fabui || typeof fabui.Control !== 'function') {
  throw new Error('Load FabUI core before fabui.gantt.');
}

var Gantt = fabui.registerLocaleTarget(
  'Gantt',
  createGanttFactory(fabui, registerControl, unregisterControl)
);
fabui.Gantt = Gantt;
